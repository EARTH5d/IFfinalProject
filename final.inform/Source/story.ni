...
After an actor eating an edible thing (called food):
	...
	if Actor is Mabel:
		...
		otherwise:
			say "Mabel says, '[one of]Hummm[or]Thanks[or]Yumy[purely at random].'";
	continue the action;
...
Report eating an edible thing (called food):
	if food is Rations:
		say "It tastes good, very good. Though[first time]after serving five years in the Federation military [only]you still do not have any idea what it is made form.";
	otherwise:
...
Instead of speech when the noun is the Grue:
	repeat through Table of Grue Responses:
		if the topic understood includes topic entry:
			say "[first time]We speak to the Grue in it's native Gruish, well broken Gruish pepper with works from Arkonkian and Kawkawgrrrr (an Avisurite language you pick a little up fighting in the war).[only][reply entry][line break]Though your Gruish is rusty.";
			rule succeeds;
...
to say dimetrodon day idle text:
	say "[one of]is basking in the setting light of the sun, peacefully[or]is approach by a bird looking creature. It just looks at the bird thing scaring it away[or]It befiely turn to look at you, before returning to mining it own bussiness[or]It looks over at the planet's setting star and sighs[in random order]";
		
Every turn when Dimetrodon is visible and Dimetrodon is alive:
	if Feeding the Grue has not happened:
		say "The Dimetrodon like creature [one of][dimetrodon day idle text][or][dimetrodon day idle text][or][dimetrodon day idle text][or][dimetrodon day idle text][or][dimetrodon day idle text][or][dimetrodon day idle text][or][dimetrodon day idle text][or][dimetrodon day idle text][or][dimetrodon day idle text][or][dimetrodon day idle text][or][dimetrodon day idle text][or][dimetrodon day idle text][or][dimetrodon day idle text][or][dimetrodon day idle text][or][dimetrodon day idle text][or]heads over towards the lake. Those croc-snakes things all either flea or choses to stand their. The Dimetrodon just ingore them[or]lowers it head to drink somewater[or]drinks water as it is approach by one of crociline python things[or]is attack by the croco-python[or]is struggling agianist one the croco-python things[or]is struggling agianist one the croco-python things[or]is struggling agianist one the croco-python things[or]is struggling agianist one the croco-python things[or]has killed the croco-python[or]drages the remains of it attacker/viticim away from the lake[or]is now feasting apon the croc-python that tried to attack it[or]is eating one of the croc-python[stopping].";
	otherwise if starset is happening:
		say "The Dimetrodon like creature [dimetrodon day idle text].";
	otherwise:
...
Carry out shooting the Grue with something:
	say "Your shot hits a force field that surrounds the Grue. They luaghs a deep gruining luagh. Perhaps you should try talking to he. Most Grues are very reasonable people, as long as they are not too hungry.";
	stop the action.
...
"dimetrodon" or "Dimetrodoniod" or "Dimetrodon like creature" or "Dimetrodon-like creature"			"[grue-dimetro-text]"
...
"grue/schoolar/schoolars/mercanary/mercanaries/grues/cooks/cook/chefs/chef/lurk/itself/himself/themself"			"'I am a Grue,' it says proudly. 'We lurk. We wait. We eat. We survive. We are Philosophers, Schoolars, Chefs and Mercanaries'."
"home" or "grue home world"			"'Far away. Small world. Dim skies, red star. One half cook. Other side dark, lovely and beatiful, but frozen. Inbewteen comfortly.' It mutters."
...
"federation/state/president/chancellor/senate" or "Democratic Federation"			"They calim not to care about this Federation Poltics."
"king/queen/kingdom/paraliment/PM" or "prime minister"			"He calims not to care about your people's poltics."
"consortium/speaker" or "grand speaker" or "supreme council" or "Syndicated Consortium"			"He calims they do not care about the poltics of the consortium."
"cold"			"'Cold is nice, in moderation that is.' The Grue replies."
"milkway" or "What are you doing here"			"You think it telling you he came to this galaxy to find work."
"god/devil"			"'Long ago we Grues tought Milk Way was god and host star was deveil.'"
"leader/government/emperor" or "supreme leader"			"It hasn't been in contact with the grue home world for long time, so it doesn't known who the current Emperor of the Grues is."
...
"avisurites/avisurite"			"'Avisurites are not very good eating. Only eat if nesscery or extremely anoyed. But these one pay good money and share food.'"
...
"doc/doctor/med/mother/mom/ma" or "brith parent"			"'My mother was a docotor,' The Grue replies."
"name"			"It does not seems like he want to give you his name."
...
"thanks/thx"			"[if the isgruefeed is true]'Your welcome', The grues tells you[otherwise]'Thanks for what?',the Grue asks you confused[end if]."
...
Instead of listening to Mabel:
	if Mabel is awake:
		say "[one of]She is quite[or]You hear her humming the tune of the Anthem of the Democratic Federation[or]She humms the Arkonkian national Anthem[or]You can hear her breathing[or]She make random noises[purely at random].";
	otherwise:
...
"Game/Chess/Cribbage"					"[one of]'You known I really like to play Cribbage or Arkonian Hexagon Chess when we get back home,' she says. You tell her you like that idea to.[or]'I still can not wait for a game of either Cribbage or Arkonian Hexagon Chess.[stopping]'"
"Grue"					"[if Has Mabel seen the Grue is false]'A what?' She says in shoacked. 'A grue? Noo. I do not belive there a Grue here[otherwise]She says, 'I did not belive you there was a Grue here when you first told me[end if].'"
...
Plants is a Backdrop in Desert. The Description of the plants is "There are many plants that inhabits this seemingly barren wasteland. The most common varity appears to be these short thorny bushs. Though there are a few trees here and there."
...
Understand "coconut", "weird coconut thing", "weird fruit" and "coconut-thing" as coconut-thing. The printed name of the coconut-thing is "wierd coconut thing". 

Fruit flesh is a thing. The Description of fruit flesh is "The pineapple-y flesh of the bush coconuts, it also has watermelons like seeds." The printed name of the fruit flesh is "weird coconut flesh". Understand "weird coconut meat", "weird fruit meat", "weird fruit flesh" and "wierd coconut flesh" as coconut-thing.

instead of inserting something into weird plant, say "This might not be a good idea, if you could get yourself poke on one of the throns if you are not careful.".
...
Instead of taking coconut-thing:
	if coconut-thing is in weird plant:
		say "Tring to be very careful not to poke yourself on the thorns of the bush, you take the coconut looikng thing. It is partly buried in the sand, but it lifts right out of the sand and the vines and roots snaps off easy.";
		if a random chance of 3 in 5 succeeds:
...
Empty Desert is a room in the Desert. "You are surrouned by empty desert for klicks around. There nothing out here, but [sand] and the occasional sign of life. It is easy to get lost out here. You might find yourself walking in cirlces. [if Mabel is in Empty Desert and turnsTraversingDesert > 0][Mabel] is still following you.[end if]"
...
The Entrance is a dark room in the holdout fort. "This tunnel is the entryway into the fort. Standing at the northern end of the Tunnel, blocking your away is [Grue] guard cowarding in the light. To the south is the [The mouth of entrance] tunnel".
...
'Yes I'm', the Grue tell her in English. He then turn to you and then asks in a very simplifed veriosn of Grueish, 'Princess ask If I Grue Right?' You nod your head. [if the Final Duel is not happening] 'Me do no known Arkonkian. Me known some English, some Spanish, some Mandarin and some Tharsisian,' the Grue adds[end if][paragraph break]You tell Mabel, 'Do not be scare, me and him has an understandong.' Mabel seems ease up apon hearing this, but she keeping an eye on the Grue.'";
...
instead of unlocking eastern door with something:
	...
	otherwise:
		say "This door will not open, even when you try pickhing it with the your multitool's 'picking' tool."
...
Second floor landing is a room in holdout fort. The description of the Second floor landing is "This is the landing of the second floor of the fort. You do not have time to explore this fort. There is a [carpeted spiral staircase] heading back down and [another spiral staricase] heading back up. You known above you is the command center."

Up of second floor landing and down of fort command center is another spiral staricase. another spiral staricase is a door. The description of the another spiral staricase is "How many spiral staircases are in this stupid fort."
...
control panel #2 is a fort control panel in fort command center. Understand "number/num/no 2" and "control panel number/num/no 2" as control panel #2.
...
control panel #4 is a fort control panel in fort command center. Understand "number/num/no 4" and "control panel number/num/no 4" as control panel #4.
...
carry out an actor cutting hyperspace radio parts:
	if hyperspace radio parts are uncutted:
		if control panel #4 is switched on:
			if Actor is visible, say "[refer to the actor] start cutting the wires conntecting the parts that you need from the rest of the panels.";
			...
			otherwise:
				say "By the way while you where not wacthing her, Mabel forgot to turn off the panel and now [refer to the actor] has taken 5 damage.[Current Health of the actor]";
		...
		otherwise:
			if Actor is visible, say "[refer to the actor] cut the wires conntecting the parts that you need with the rest of the panels.";
	...
	otherwise:
		say "There is no need to cut them, they ahve already been cutted.";
...
When Fixing the Radio ends:
	if the player is in Pod Interor, say "congratulations the hyperspace radio is now fixed. Now you can contact the space force.";
	now did Mabel do something is true;
...
Fur blanket is a supporter. The description of The fur blanket is "It looks like a blanket make out of the hide of a furrly animal. It not big enouch for you, but it the perfect side for two or three of these tiny creatures to snuggle up agiast eachother under."
...
When the final duel begins:
	...
	say "You and Mabel enter the Atrium and see a female Avisurite wearing a Consortium Officer uniform standing in the middle of the room. She looks at both of you and Tweets, Chirps, Barks and Growls before saying in perfect english in athick angloamerican accent, 'How? How did you make it pass the Grue. They are like my one underling that actually manange to pull thier wieght around here and you, known what it does matter.' She then turn to her soidlers and Hissses in KawKawGrrrrr, 'Attack!!!!!!!'";
...
Every turn during The Final Duel:
	...
	if the Avisurite Soilder is not in the location of the player and Avisurite Soilder is undefeated:
